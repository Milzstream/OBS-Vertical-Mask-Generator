...
| `presence.cpp` | Auto-hide shared cycle and outline match |
...
Auto-hide compares the outer band of the mask to the Draw mask still (`masks/<uuid>.ref`). Fade and Match sliders sit next to the checkbox. `presence.cpp` runs the shared downsample cycle.
